    ...
    days: [
      {
        ...
        exercises: [
          { exerciseId: "explosive-pushup", sets: 4, reps: "8" },
          { exerciseId: "diamond-pushup", sets: 4, reps: "12" },
          { exerciseId: "hollow-hold", sets: 4, reps: "25s" },
      ...
      },
      {
        ...
        exercises: [
          { exerciseId: "jump-lunge", sets: 4, reps: "12" },
          { exerciseId: "jump-squat", sets: 4, reps: "15" },
          { exerciseId: "side-plank", sets: 4, reps: "30s per lato" },
          { exerciseId: "shoulder-tap-plank", sets: 4, reps: "25" },
        ],
      },
    ],
  },
